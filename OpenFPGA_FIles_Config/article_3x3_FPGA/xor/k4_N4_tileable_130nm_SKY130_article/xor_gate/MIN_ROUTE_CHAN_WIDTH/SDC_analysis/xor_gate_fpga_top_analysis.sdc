...
# Create clock                                    
##################################################
create_clock clk[0] -period 1.155891938e-09 -waveform {0 5.779459689e-10}

##################################################
# Create input and output delays for used I/Os    
##################################################
set_input_delay -clock clk[0] -max 1.155891938e-09 gfpga_pad_GPIO_PAD[3]
set_input_delay -clock clk[0] -max 1.155891938e-09 gfpga_pad_GPIO_PAD[4]
set_output_delay -clock clk[0] -max 1.155891938e-09 gfpga_pad_GPIO_PAD[7]
